...
public final class ItemDisplayControllerProvider implements
    Provider<ViewModelController<Station, AnvilDisplayBinding>> {

  private final Plugin plugin;

  @Inject
  public ItemDisplayControllerProvider(Plugin plugin) {
    this.plugin = plugin;
  }

  @Override
  public ViewModelController<Station, AnvilDisplayBinding> get() {
