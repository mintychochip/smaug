...
//
//final class ProgressBarViewModel extends AbstractViewModel<Station<TrackableProgressMeta>, BossBar, UUID> {
//
...
//  @Override
//  @NotNull
//  IParameterizedFactory<BossBar, Station<TrackableProgressMeta>> getViewFactory() {
//    return data -> {
