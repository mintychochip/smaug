...
public final class AnvilGuiViewModel extends
    AbstractViewModel<StationPlayerProxy<ITrackableProgressMeta>, AnvilGuiProxy, Integer> {
  ...
  static final class AnvilGuiBinding extends AbstractBinding {
    ...
    @ExposedProperty("gui-selector-item")
    private final GuiItem selectorItem;
    @ExposedProperty("gui")
    ...
    AnvilGuiBinding(GuiItem selectorItem, Gui mainGui, RecipeSelectorItem recipeSelectorItem) {
  ...
  @Override
  public void update(@NotNull StationPlayerProxy<ITrackableProgressMeta> model) {
    ...
    ITrackableProgressMeta meta = model.getStation().getMeta();
    ...
    List<SmaugRecipe> recipes = Smaug.getRecipeFetcher()
        .all(model.getStation().getKey(), meta.getInventory()
            .getContents());
    recipeSelectorItem.recipeSelectorGui().update(recipes);
    recipeSelectorItem.codexGui().update(Smaug.fetchAllRecipes(model.getStation()));
  ...
  @Override
  @NotNull
  IFactory<AnvilGuiProxy, StationPlayerProxy<ITrackableProgressMeta>> getViewFactory() {
    return factory;
  }
  ...
  @Override
  @NotNull Integer modelToKey(@NotNull StationPlayerProxy<ITrackableProgressMeta> model) {
