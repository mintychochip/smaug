...
public class SmithCommand implements CommandExecutor {
  ...
  private final IMetaStationDatabaseService<ITrackableProgressMeta> service;

  @Inject
  public SmithCommand(IMetaStationDatabaseService<ITrackableProgressMeta> service) {
  ...
  public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command,
    ...
    IMetaStation<ITrackableProgressMeta> mutableStation = service.getStation(
